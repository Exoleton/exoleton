          ...
          <form class="nav-search flex-grow-1 my-3 my-lg-0" method="get" action="recherche.php" role="search">
            <div class="nav-search-bar" role="group" aria-label="Search">
              ...
              <div class="nav-search-input">
                ...
                <input id="navSearchQuery" name="q" type="search" class="form-control" placeholder="Industrial exoskeleton, walking aid…" value="<?php echo $sanitizedQuery; ?>" data-i18n-placeholder="search.placeholder">
              </div>

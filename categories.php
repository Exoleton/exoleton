...
function bootstrap_categories_schema(PDO $pdo): void
{
    ...
    $pdo->exec("ALTER TABLE products ADD COLUMN IF NOT EXISTS category_slug VARCHAR(150) NULL AFTER category");
    $pdo->exec("ALTER TABLE guides ADD COLUMN IF NOT EXISTS category_slug VARCHAR(150) NULL AFTER category");
